...
import ContactForm from "../contact/ContactForm"; // Adjust path if needed
...
export default function AboutPage() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 space-y-16 bg-gradient-to-br from-gray-50 to-blue-50/30 dark:from-gray-900 dark:to-gray-800 min-h-screen">
      ...
      {/* ----------- Contact Me Section (Combined) ----------- */}

      <div className="max-w-5xl mx-auto px-4 py-12 bg-gradient-to-br from-gray-50 to-blue-50/30 min-h-screen space-y-12">
        {/* Header */}
